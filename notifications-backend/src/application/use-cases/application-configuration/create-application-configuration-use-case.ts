...
import { CreateApplicationConfigurationDTO } from "./dto";

export class CreateApplicationConfigurationUseCase {

    constructor(private applicationConfigurationRepository: IApplicationConfigurationRepository) { }

    async execute(input: CreateApplicationConfigurationDTO): Promise<ApplicationConfiguration | null> {
        const {
            application,
        ...
        return this.applicationConfigurationRepository.insert(applicationConfiguration)
    }
